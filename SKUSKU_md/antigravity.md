...
| 파일명 | 역할 (Role) | 핵심 내용 |
| :--- | :--- | :--- |
| **`about_SKUSKU.md`** | **기획서 (Why & What)** | 
| **`DesignGuide.md`** | **디자인 (How it looks)** | 컬러 코드(Strict), 폰트, UI 컴포넌트, 레이아웃 |
...
1.  **참조 확인:** "네, `design_guide.md`의 **Primary Color**를 사용하여 작업을 시작합니다." (근거 제시)
